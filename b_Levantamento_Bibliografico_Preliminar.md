...
|---|---|---|---|---|
| 1 | `["c(ycle enumeration" OR "simple cycles" OR "cycle detection") AND ("directed graph" OR "transaction graph" OR "transaction network") AND ("time complexity" OR "exponential" OR "pruning" OR "scalability")]` | `[Complexidade Assintotica — gargalo do modulo cycle_detection.py]` | `[ACM DL; IEEE Xplore; Springer Link]` | `[Caio Winkler Marangoni]` |
...
| 1 | `[("Graph Neural Network*" OR "GNN") AND ("Financial Fraud" OR "Fraud Detection" OR "Transaction Fraud")]` | `[Detecção de fraudes em grafos financeiros / Análise de transações atípicas (cycle_detection.py)]` | `[Springer / IEEE / ACM]` | `[Guilherme Libório Camargo]` |
| 2 | `[("Complex Event Processing" OR "CEP") AND ("Graph Processing" OR "Stream Analytics") AND ("Real-time" OR "Parallel")]` | `[Processamento de eventos complexos e análise de grafos em tempo real (centralidade.py)]` | `[ACM Digital Library / IEEE]` | `[Guilherme Libório Camargo]` |
| 3 | `[("Graph Anomaly Detection" OR "GAD") AND ("Supervised Learning" OR "Benchmark*" OR "Graph Mining")]` | `[Análise e benchmark de detecção de anomalias em estruturas de grafos (scc.py)]` | `[NeurIPS / Google Scholar / ScienceDirect]` | `[Guilherme Libório Camargo]` |
| 1 | `[("data engineering" OR "feature engineering" OR "data preprocessing") AND ("fraud detection" OR "financial fraud") AND ("computational complexity" OR "scalability")`] | `[Engenharia de dados, pré-processamento de transações e complexidade computacional para pipelines em larga escala (Relação: (cycle_detection.py.)]` | `[ScienceDirect (Elsevier)]` | `[Ryan dos Santos Veloso]`|
| 2 | `[("machine learning" OR "classification algorithms") AND ("financial fraud detection" OR "banking fraud") AND ("performance evaluation" OR "benchmark")]` | `[Avaliação de desempenho de algoritmos em fraudes financeiras e métricas de relevância (Relação: (centralidade.py).]` | `[MDPI]` | `[Ryan dos Santos Veloso]` |
| 3 | `[("graph analysis" OR "graph algorithms" OR "path detection") AND ("fraudulent accounts" OR "money laundering") AND ("parallel paths" OR "cycle detection" OR "strongly connected components")]` | `[Algoritmos em grafos, detecção de caminhos paralelos e subestruturas fortemente conectadas/cíclicas em redes bancárias (Relação: (scc.py) e (cycle_detection.py).]` | `[PubMed Central / IEEE Xplore / ScienceDirect]` | `[Ryan dos Santos Veloso]` |
...
- `[ex.: artigos publicados nos últimos 5-10 anos]`
- `[ex.: revisados por pares]`
- `[ex.: em português/inglês]`
- `[ex.: disponíveis na íntegra]`
- `[ ]`

**Critérios de exclusão:**
- `[ex.: resumos sem texto completo]`
- `[ex.: duplicatas]`
- `[ex.: artigos fora do escopo do tema]`
- `[ex.: não revisados por pares]`
- `[ ]`

*Definidos em conjunto por: `[Nomes]`*
...
**Total de resultados brutos (soma de todas as buscas):** `[ ]`

**Gerenciador de referências utilizado:** `[ex.: Zotero, Mendeley, EndNote]`
...
1. `[Referência completa 1]`
2. `[Referência completa 2]`
3. `[Referência completa 3]`
...
- **Passo(s) em que atuou:** `[ex.: Passos 2, 3 e 6]`
...
|---|---|---|
| 1. Pergunta e palavras-chave | `[Nome(s)]` | `[ ]` |
| 2. Strings de busca | `[Nome(s)]` | `[ ]` |
| 3. Bases de dados | `[Nome(s)]` | `[ ]` |
| 4. Critérios de inclusão/exclusão | `[Nome(s)]` | `[ ]` |
| 5. Execução das buscas | `[Nome(s)]` | `[ ]` |
| 6. Triagem título/resumo | `[Nome(s)]` | `[ ]` |
| 7. Triagem texto completo | `[Nome(s)]` | `[ ]` |
...
**Fase 1 — Planejamento**
- [ ] Pergunta de pesquisa de trabalho definida
- [ ] Conceitos-chave e sinônimos (PT/EN) listados
- [ ] Strings de busca elaboradas com operadores booleanos
- [ ] Bases de dados escolhidas e justificadas
- [ ] Critérios de inclusão e exclusão definidos
