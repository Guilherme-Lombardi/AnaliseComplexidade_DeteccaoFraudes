...
| 1 | `[("Graph Neural Network*" OR "GNN") AND ("Financial Fraud" OR "Fraud Detection" OR "Transaction Fraud")]` | `[Detecção de fraudes em grafos financeiros / Análise de transações atípicas (cycle_detection.py)]` | `[ACM DL; ScienceDirect; arXiv]` | `[Guilherme Libório Camargo]` |
| 2 | `[("Complex Event Processing" OR "CEP") AND ("Graph Processing" OR "Stream Analytics") AND ("Real-time" OR "Parallel")]` | `[Processamento de eventos complexos e análise de grafos em tempo real (centralidade.py)]` | `[Springer Link; IEEE Xplore; arXiv]` | `[Guilherme Libório Camargo]` |
| 3 | `[("Graph Anomaly Detection" OR "GAD") AND ("Supervised Learning" OR "Benchmark*" OR "Graph Mining")]` | `[Análise e benchmark de detecção de anomalias em estruturas de grafos (scc.py)]` | `[ACM DL; Springer Link; arXiv]` | `[Guilherme Libório Camargo]` |
