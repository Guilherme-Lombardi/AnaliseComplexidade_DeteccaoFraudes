...
| 1 | `[("Graph Neural Network*" OR "GNN") AND ("Financial Fraud" OR "Fraud Detection" OR "Transaction Fraud")]` | `[Processamento de Fluxos de Dados — a hipotese: reduzir o volume antes da travessia]` | `[ACM DL; ScienceDirect; arXiv]` | `[Caio Winkler Marangoni]` |
| 2 | `[("Complex Event Processing" OR "CEP") AND ("Graph Processing" OR "Stream Analytics") AND ("Real-time" OR "Parallel")]` | `[Base experimental — origem e limites do dataset usado no sistema]` | `[Springer Link; IEEE Xplore; arXiv]` | `[Caio Winkler Marangoni]` |
| 3 | `[("Graph Anomaly Detection" OR "GAD") AND ("Supervised Learning" OR "Benchmark*" OR "Graph Mining")]` | `[String-sintese: reproduz a pergunta de pesquisa do item 1.1 (pipeline hibrido)]` | `[ACM DL; Springer Link; arXiv]` | `[Caio Winkler Marangoni]` |
